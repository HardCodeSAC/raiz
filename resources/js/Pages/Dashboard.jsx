                ...
                <div className="row">
                                    ...
                                    <div className="table-responsive">
                                        <table className="table table-hover m-b-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>HeadPhone</td>
                                                    <td><img src="assets/images/widget/p1.jpg" alt="" className="img-20"></img></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>Iphone 6</td>
                                                    <td><img src="assets/images/widget/p2.jpg" alt="" className="img-20"></img></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>Jacket</td>
                                                    <td><img src="assets/images/widget/p3.jpg" alt="" className="img-20"></img></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>Sofa</td>
                                                    <td><img src="assets/images/widget/p4.jpg" alt="" className="img-20"></img></td>
                                                    <td>
                                                        <div><label className="badge badge-light-danger">Cancel</label></div>
                                                    </td>
                                                    <td>$85</td>
                    ...
                    <div className="col-xl-6 col-md-12">
                        ...
                        <div className="card feed-card">
                            ...
                            <div className="feed-scroll" style="height:385px;position:relative;">
                                <div className="card-body">
